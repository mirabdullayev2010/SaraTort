...
public class CakeOptionForUpdateValidator : AbstractValidator<CakeOptionForUpdateDto>
{
    public CakeOptionForUpdateValidator()
    {
        RuleFor(x => x.Id)
            .GreaterThan(0)
            .WithMessage("Cake Option ID noto'g'ri.");
